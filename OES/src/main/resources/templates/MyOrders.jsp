		...
		<div  class="container">
			<table style="text-align:center" class="table table-bordered">
				...
				<!-- 	<% for(Order order:orderlist){
					...
					%>
				 -->	<tr  th:each="allOrders:${allOrders}">
						<td scope="row"></td>
					...
					<!-- 	<%List<Customer> C_Address_details = mod.getAddressDetailByID(order.getAddressId());
					 ...
					 -->	<td><%=custo.getC_name() %></td><%} %>
						...
						<td><a th:href="@{'/OrderDetails'+ ${allOrders.order_Id} +','+${allOrders.address_Id } }" type="button" style="color:white;" class="btn btn-primary btn-sm">DEATAILS</a></td>
