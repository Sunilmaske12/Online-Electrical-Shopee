					...
					%>	
							<div class="d-flex justify-content-start mb-4">
								...
								<div class="msg_cotainer">
									<%=c.getMessage() %>
									<span class="msg_time"><%=c.getChat_time() %>|| <%=c.getChat_date() %></span>
								</div>
							</div>
							...
							<div class="d-flex justify-content-end mb-4">
								<div class="msg_cotainer_send">
									<%=c.getMessage() %>
									<span class="msg_time_send"><%=c.getChat_time() %>|| <%=c.getChat_date() %></span>
								</div>
								<div class="img_cont_msg">
						...
						<div class="card-footer">
							...
							<form action="chat">
							<div class="input-group"><%if(status!=null){ if(status.equals("Close")){%>
							<div style="text-align:center; margin-left:30%;"><h4>Ticket is closed</h4></div>
