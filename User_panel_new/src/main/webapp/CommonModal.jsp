...
<div class="modal fade" id="AddNewAddress" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div style="padding:20px" class="modal-content">
      ...
      <div class="modal-body">
         <form class="addressForm" action="SaveAddress?user_id=<%=user_id %>" method="post">
                    <input type="hidden" name="_token" value="7izNrBqYjX16Icbzz1Vn8FgvFZk2Gjn6Ty3VcVjT">
                    <input type="hidden" value="website-checkout-shipping-address" name="page">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Contact</label>
                                <input type="text" name="mobile" class="form-control" onkeypress="INGENIOUS.numericInput(event)" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea name="address" placeholder="Enter Your Address" class="form-control" cols="30" rows="4" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Pincode</label>
                                <input type="text" name="pincode" class="form-control" onkeypress="INGENIOUS.numericInput(event)" value="" required>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div style="padding:20px" class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div><% String id=request.getParameter("editid");
System.out.print(id);%>
      <div class="modal-body">
         <form class="addressForm" action="SaveAddress?user_id=<%=user_id %>" method="post">
                    <input type="hidden" name="_token" value="7izNrBqYjX16Icbzz1Vn8FgvFZk2Gjn6Ty3VcVjT">
