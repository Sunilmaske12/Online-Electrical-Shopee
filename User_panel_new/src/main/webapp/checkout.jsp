                                 ...
                                 %>
                                            ...
                                            <div class="col-2 col-md-1">
                                                <div class="radio radio-success">
                                                    <input type="radio" name="address_id" value="<%=a.getC_id() %>" id="selectAddress0" aria-invalid="false" required>
                                            ...
                                            <div class="col-md-11 col-10">
                                                ...
                                                <a href="EditAddress?id=1994" class="badge bg-danger pull-right">Edit</a>
						...
						<div style="margin-left: 150px;" class="col-lg-4 col-md-6">
							<div class="checkout__order">
								...
								<div class="checkout__order__subtotal">
									Subtotal <span>Rs. 750.99</span>
								</div>
								<div  class="checkout__order__total">
									Delivery Charges <span style="color:black;">$00</span>
								</div>
								<div class="checkout__order__total">
									Total <span>$750.99</span>
								</div>
								<a ><button type="submit" onclick="window.location.href='Payment.jsp';" class="site-btn">Continue</button></a>
								</div>
